...
const Hero = () => { 
  ...
  return ( 
    <section 
      ref={sectionRef} 
      className="relative w-full min-h-screen h-auto lg:h-screen bg-[#050505] overflow-hidden lg:overflow-hidden flex flex-col justify-between select-none cursor-none" 
    > 
      <style>{` 
        @keyframes marquee { 
      ...
      <div ref={contentRef} className="hero-mobile-scroll relative z-20 w-full max-w-7xl mx-auto px-5 sm:px-6 md:px-12 h-full flex flex-col justify-between pt-24 sm:pt-24 md:pt-24 pb-8 sm:pb-10 md:pb-12"> 
         
        {/* Top Netflix Cinematic Badge */} 
        <div className="hero-anim-item flex items-center justify-between w-full shrink-0"> 
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded bg-black/80 backdrop-blur-2xl border border-red-600/40 text-[9px] sm:text-xs font-mono uppercase tracking-widest text-white shadow-2xl max-w-full"> 
            <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 shrink-0 rounded-full bg-red-600 animate-ping"></span> 
            <span className="text-red-500 font-bold tracking-wider whitespace-nowrap">NETFLIX DEVELOPER SERIES</span> 
            <span className="text-white/40 shrink-0">|</span> 
            <span className="text-white/80 whitespace-nowrap">SEASONS 2024 - 2026</span> 
          </div> 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-5 sm:gap-6 lg:gap-8 my-auto py-6 sm:py-8 lg:py-0"> 
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-4 sm:space-y-5 text-left"> 
            ...
            <div className="hero-anim-item flex items-center gap-3 sm:gap-5 py-1 sm:py-2 flex-wrap"> 
            ...
            <h1 className="hero-anim-item text-[2.55rem] leading-[0.92] sm:text-5xl md:text-7xl font-black tracking-tighter text-white drop-shadow-[0_15px_30px_rgba(0,0,0,0.9)]"> 
              PRATHI DHASWANTH NAG<br /> 
            ...
            <div className="hero-anim-item flex items-center gap-2 sm:gap-3 text-[9px] sm:text-xs font-mono text-red-400 font-bold flex-wrap"> 
              <span className="px-2 py-0.5 bg-red-500/10 border border-red-500/30 rounded text-red-500">99.9% Uptime</span> 
              <span className="text-white/40">•</span> 
              <span>Java • Node.js • Spring Boot • AWS</span> 
              <span className="text-white/40">•</span> 
            ...
            {/* Action Button Set */} 
            <div className="hero-anim-item flex items-center gap-3 sm:gap-4 pt-1 sm:pt-2 flex-wrap"> 
              <a 
                href="#projects" 
                className="px-5 sm:px-8 py-3 sm:py-3.5 bg-white text-black font-bold text-[10px] sm:text-xs uppercase tracking-widest rounded hover:bg-red-600 hover:text-white transition-all duration-300 shadow-[0_10px_35px_rgba(255,255,255,0.3)] flex items-center gap-2 hover:scale-105 active:scale-95" 
              > 
          ...
          <div className="lg:col-span-4 flex justify-center perspective-[1200px] mt-2 sm:mt-3 lg:mt-0"> 
            <div  
              ref={cardRef} 
            ...
            > 
              ...
              <div className="relative w-[235px] xs:w-[250px] sm:w-[280px] md:w-[320px] p-2.5 sm:p-3.5 bg-[#141414]/90 backdrop-blur-2xl rounded-2xl border border-red-600/40 shadow-[0_40px_80px_rgba(0,0,0,0.95)] overflow-hidden"> 
                ...
                {/* Netflix Series Tag */} 
                <div className="absolute top-5 left-5 sm:top-6 sm:left-6 z-30 px-2.5 sm:px-3 py-1 bg-red-600 text-white font-mono text-[9px] sm:text-[10px] font-bold tracking-widest rounded shadow-xl"> 
                  FEATURED DEV 
                </div> 
                ...
                <img 
                  ...
                  className="w-full h-[270px] xs:h-[300px] sm:h-[330px] md:h-[390px] object-cover rounded-xl filter contrast-125 brightness-105 group-hover:scale-[1.02] transition-transform duration-500" 
                /> 
              </div> 
            </div> 
          </div> 
            ...
            <div className="p-4 sm:p-5 bg-black/80 backdrop-blur-2xl border border-white/15 rounded-xl shadow-2xl max-w-xs"> 
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold mb-2">Core Stack</h3> 
                <p className="text-xs text-white/80 leading-relaxed font-light"> 
                  Full-Stack Development, Java, Spring Boot, React.js, Node.js, Python, AWS. 
                </p> 
            </div> 
          </div> 
        ...
        <div className="hero-anim-item flex items-center justify-between text-[9px] sm:text-xs font-mono text-white/50 tracking-widest uppercase gap-4 shrink-0"> 
        <span>ENGINEERED FOR PERFORMANCE</span> 
        <span className="text-right">[ DHASWANTH NAG PRATHI • 2026 ]</span> 
        </div> 
      </div> 
      ...
      <header className="absolute top-0 left-0 z-50 w-full max-w-7xl mx-auto px-5 sm:px-6 md:px-12 py-5 sm:py-6 flex items-center justify-between pointer-events-auto"> 
        <div className="text-xl sm:text-2xl font-black text-red-600 tracking-tighter flex items-center gap-2 drop-shadow-[0_2px_15px_rgba(229,9,20,0.9)]"> 
          DHASWANTH NAG<span className="w-1.5 h-1.5 rounded-full bg-white inline-block"></span> 
        </div> 
